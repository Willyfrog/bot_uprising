...
METADATA = {
    ...
    'description':      'One mad scientist must defeat his rogue AI with the garbage collector he has found',
    'author':           'Willyfrog',
    #'author_email':     '',
...
PACKAGEDATA = {
    ...
    'package_dir': {'bot_uprise': 'bot_uprise',
                   },
    'packages': ['bot_uprise',
                ],
    'scripts': ['scripts/bot_uprise'],
}
...
_DATA_DIR = os.path.join('bot_uprise', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'bot_uprise': data_dirs}
...
src = []
add_files(src,os.walk('bot_uprise'))
